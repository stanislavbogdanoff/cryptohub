  ...
  return (
    <div className='globals'>
      ...
      <div className="globals-info">
        ...
        <p>Global Crypto Stats are always worth looking out for! Watch the Bitcoin dominance closely: when it rises, the altcoins go down, and vice versa. Other than that, the global coins traded might be of interest to you.</p>
